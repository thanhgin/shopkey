window.onload = function () {
	...
	addBanner("img/banners/banner_fake.png", "img/banners/banner_fake.png");
	...
	*/
	...
	["Windows", "Office", "Macbook"];
	for (var t of tags) addTags(t, "index.html?search=" + t);

	// Thêm danh sách hãng điện thoại
	var company = 
	//["Apple.jpg", "Samsung.jpg", "Oppo.jpg", "Nokia.jpg", "Huawei.jpg", "Xiaomi.png", "Realme.png", "Vivo.jpg", "Philips.jpg", "Mobell.jpg", "Mobiistar.jpg", "Itel.jpg", "Coolpad.png", "HTC.jpg", "Motorola.jpg"];
	["Windows", "Office", "Macbook", "Khác"];
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('Windows', blue, ['promo=win', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('Office', yellow_red, ['promo=off', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('Macbook', green, ['promo=mac', 'sort=rateCount-decrease'], soLuong, div);
